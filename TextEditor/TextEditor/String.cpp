...
void String::Concat(String &addTo, const String &addOn)
...
String String::Read(istream &input)
// 操作结果：从输入流读入串
{
...
void String::Copy(String &copy, const String &original)
...
void String::Copy(String &copy, const String &original, int n)
...
int String::Index(const String &target, const String &pattern, int pos)
